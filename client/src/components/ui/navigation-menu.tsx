...
>(({ className, children, viewport = true, ...props }, ref) => {
  const Root = NavigationMenuPrimitive.Root as any
  return (
    <Root
      ref={ref}
...
>(({ className, ...props }, ref) => {
  const List = NavigationMenuPrimitive.List as any
  return (
    <List
      ref={ref}
...
>(({ className, ...props }, ref) => {
  const Item = NavigationMenuPrimitive.Item as any
  return (
    <Item
      ref={ref}
...
>(({ className, children, ...props }, ref) => {
  const Trigger = NavigationMenuPrimitive.Trigger as any
  return (
    <Trigger
      ref={ref}
...
>(({ className, ...props }, ref) => {
  const Content = NavigationMenuPrimitive.Content as any
  return (
    <Content
      ref={ref}
...
>(({ className, ...props }, ref) => {
  const Viewport = NavigationMenuPrimitive.Viewport as any
  return (
    <div
      className={cn(
...
>(({ className, ...props }, ref) => {
  const Link = NavigationMenuPrimitive.Link as any
  return (
    <Link
      ref={ref}
...
>(({ className, ...props }, ref) => {
  const Indicator = NavigationMenuPrimitive.Indicator as any
  return (
    <Indicator
      ref={ref}
